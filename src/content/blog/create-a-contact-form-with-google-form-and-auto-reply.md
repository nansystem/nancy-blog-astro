...
![Google フォーム初期画面](../../assets/images/20190220-1.jpg)

フォームタイトル、質問、回答方法を順次入力し、質問を追加ボタンでフォームを追加していく。

![Google フォーム](../../assets/images/20190220-2.jpg)
...
![設定](../../assets/images/20190220-12.jpg)

![フォーム送信後の表示設定](../../assets/images/20190220-11.jpg)
...
![スクリプトエディタ](../../assets/images/20190220-14.jpg)

スクリプト エディタが開くので左上の「無題のプロジェクト」をクリックし、プロジェクト名を入力する。

![プロジェクト名](../../assets/images/20190220-15.jpg)
...
![関数を実行](../../assets/images/20190220-16.jpg)
...
![フォームの入力内容](../../assets/images/20190220-20.jpg)
...
メールは`GmailApp.sendEmail(email, subject, body);`により送信できる。
...
![メール送信](../../assets/images/20190220-21.jpg)
このアプリは確認されていませんと表示されるので、詳細を押し、自動返信(安全でないページ)に移動のリンクを押す。

![承認が必要です](../../assets/images/20190220-22.jpg)

アカウントへのアクセスをリクエストされるので、問題なければ許可ボタンを押す。
これであなたのメールアドレスからfunctionでメールを送信できるようになる。

![安全でないページ](../../assets/images/20190220-23.jpg)
...
![自動返信の確認](../../assets/images/20190220-24.jpg)

すると、入力したメールアドレスにメールが届いている！すばらしい。  
これで自動返信の設定もできた。

![受信メール](../../assets/images/20190220-25.jpg)
