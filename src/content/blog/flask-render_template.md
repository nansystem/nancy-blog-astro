...
description: Flaskのrender_templateでHTMLを返す方法を解説。Jinja2テンプレートでの変数埋め込み、if/for制御構文、extendsによるレイアウト分割まで。
date: 2019-05-06
categories:
  - Flask
...
![Flaskからindex.htmlが返される](../../assets/images/20190506-index.png)
...
![HTMLに変数を表示できる](../../assets/images/20190506-index-variables.png)
...
![forで表示する例](../../assets/images/20190506-for-example.png)
...
![extendでファイルを分割](../../assets/images/20190506-layout-extend.png)
