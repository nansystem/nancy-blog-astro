...
ドメインは「.com」が安いかな。
![スタードメインでドメインを取得する](/images/20190202-star-domain__home.png)
...
![ドメインの追加](/images/20190202-firebase__domain-connect.png)

所有権の確認画面が表示される。TXTレコードの値が表示されるので、コピーボタンから値をコピーする。
この値を次にドメインの管理画面に設定する
![所有権の確認](/images/20190202-firebase__txt.png)
...
![TXTレコード追加](/images/20190202-start-domain__txt.png)
...
![Aレコード追加](/images/20190202-start-domain__a.png)
...
![wwwドメイン設定](/images/20190202-firebase__www.png)
