...
ドメインは「.com」が安いかな。
![スタードメインでドメインを取得する](../../assets/images/20190202-star-domain__home.png)

ドメインを取得して管理画面を表示したら、サイドナビの「スタードメイン管理」から「管理ドメイン一覧」を選択する。
取得したドメイン名が管理されていることを確認できる。
![スタードメインでドメインの管理画面](../../assets/images/20190202-star-domain__manage.png)
...
![ドメインの追加](../../assets/images/20190202-firebase__domain-connect.png)

所有権の確認画面が表示される。TXTレコードの値が表示されるので、コピーボタンから値をコピーする。
この値を次にドメインの管理画面に設定する
![所有権の確認](../../assets/images/20190202-firebase__txt.png)
...
![TXTレコード追加](../../assets/images/20190202-start-domain__txt.png)
...
![Aレコード追加](../../assets/images/20190202-start-domain__a.png)
...
![wwwドメイン設定](../../assets/images/20190202-firebase__www.png)
...
![wwwドメイン設定](../../assets/images/20190202-chrome__ok.png)
